...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/faiss-split-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/faiss-split-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9713&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/faiss-split-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_microarch_level1" alt="variant">
                </a>
              </td>
            </tr><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9713&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/faiss-split-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_microarch_level3" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi add faiss faiss-cpu faiss-gpu faiss-proc libfaiss
# for installing globally
pixi global install faiss faiss-cpu faiss-gpu faiss-proc libfaiss
```
...
It is possible to list all of the versions of `faiss` available on your platform:
...
```
pixi search faiss --channel conda-forge
```
